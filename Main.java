...
public class Main {
    ...
    static class MultiSet<T> {
        ...
        // Returns the smallest element in this muresiset greater than or equal to the given
        // element, or null if there is no such element
        public T ceiling(T element) {
            return frequency.ceilingKey(element);
        }

        // Returns the greatest element in this muresiset less than or equal to the given element,
        // or null if there is no such element
        public T floor(T element) {
            return frequency.floorKey(element);
        }

        // Returns the smallest element in this muresiset strictly greater than the given element,
        // or null if there is no such element
        public T higher(T element) {
            return frequency.higherKey(element);
        }

        // Returns the greatest element in this muresiset strictly less than the given element, or
